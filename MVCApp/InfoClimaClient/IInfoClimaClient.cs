...
namespace InfoClima
{
    ...
    /// <summary>
    /// </summary>
    public partial interface IInfoClimaClient : IDisposable
    {
        /// <summary>
        ...
        /// </param>
        Task<HttpOperationResponse<IList<WeatherForecast>>> ApiSampleDataWeatherForecastsGetWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
